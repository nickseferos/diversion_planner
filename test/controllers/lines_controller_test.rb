...
class LinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create line" do
    assert_difference('Line.count') do
      post lines_url, params: { line: { diversion_rate: @line.diversion_rate, name: @line.name } }
    end
  ...
  test "should update line" do
    patch line_url(@line), params: { line: { diversion_rate: @line.diversion_rate, name: @line.name } }
